...
HD_PWD='C:/Users/ismet/vivado/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log asd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source asd.tcl -notrace
