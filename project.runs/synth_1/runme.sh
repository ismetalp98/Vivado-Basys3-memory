...
HD_PWD='C:/Users/ismet/vivado/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log asd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source asd.tcl
